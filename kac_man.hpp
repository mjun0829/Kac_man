...
/*
	...
	*/
	...
	public:
		...
		void push_root_R(std::stack<char> ref) { root = ref; root.push('R'); }	//root 에 R 대입
		void push_root_L(std::stack<char> ref) { root = ref; root.push('L'); }	//root 에 L 대입
		void push_root_U(std::stack<char> ref) { root = ref; root.push('U'); }	//root 에 U 대입
		void push_root_D(std::stack<char> ref) { root = ref; root.push('D'); }	//root 에 D 대입
